angular.module('myApp')
  .controller('customersCtrl', function($rootScope, $scope, mainService, $state) {
        ...
        $scope.customers = [
          { name: "Toyota", status: "Current Customer (active)", prod: "http://torchlms.com", uat: "http://.torchlms.com"},
          { name: "Hyundai of Canada", status: "Current Customer (active)", prod: "https://torchlms.com/login/default-view?forceManual=true", uat: "https://torchlms.com/login/default-view?forceManual=true"},
          { name: "Devereux", status: "Current Customer (active)", prod: "https://torchlms.com/login/defaultView", uat: "https://torchlms.com/login/defaultView"},
